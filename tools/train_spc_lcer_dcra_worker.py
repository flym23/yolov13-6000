#!/usr/bin/env python3
"""Train one deterministic P0--P3 SPC-LCER-DCRA seed on URPC2020half."""
...
# Three concurrent workers share one GPU; do not create the unstable pin-memory thread.
os.environ["PIN_MEMORY"] = "false"
from spc_lcer_dcra_experiments import MODEL_FILES, STRUCTURES, resolve_model  # noqa: E402
...
def validate_data_yaml(path: Path) -> None:
    """Require the fixed four-class URPC2020half protocol."""
