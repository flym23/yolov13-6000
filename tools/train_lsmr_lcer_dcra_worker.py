#!/usr/bin/env python3
"""Train one deterministic R1--R3 LSMR-LCER-DCRA seed on URPC2020half."""
...
from lsmr_lcer_dcra_experiments import MODEL_FILES, STRUCTURES, resolve_model  # noqa: E402
