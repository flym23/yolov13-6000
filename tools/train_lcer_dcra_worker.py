...
# Three concurrent workers share one GPU. Avoid the asynchronous pin-memory
# teardown failure observed on this runtime while retaining workers=2.
os.environ["PIN_MEMORY"] = "false"
from lcer_dcra_experiments import MODEL_FILES, STRUCTURES, resolve_model  # noqa: E402
