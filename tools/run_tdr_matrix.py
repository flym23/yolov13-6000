...
class TDRMatrixRunner:
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.training_root = self.root / "runs" / "train" / f"tdr_{args.run_id}"
        self.test_root = self.root / "runs" / "test" / f"tdr_{args.run_id}"
    ...
    def train_variant(self, variant: str) -> dict[int, Path]:
        ...
        # Training artifacts, including live per-seed logs, stay in the train tree.
    ...
    def evaluate_variant(self, variant: str, weights: dict[int, Path]) -> list[dict[str, Any]]:
        ...
        # Test logs are part of the test artifacts and stay in the test tree.
    ...
    def write_summary(self, records: list[dict[str, Any]]) -> Path:
        ...
        for variant in self.completed:
            ...
            variants[variant] = {
                ...
                "runs": stage_records,
                "metrics_percent": {
                    name: mean_std([float(record[name]) for record in stage_records])
