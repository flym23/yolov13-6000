...
def parse_args():
    ...
    parser.add_argument(
        "--weights",
        default="/home/rtx6000/ZZF/yolov13-6000/runs/train/dcra_20260714_210218_a5_k5_seed1/weights/best.pt",
        help="Path to best.pt or another trained checkpoint.",
    )
    parser.add_argument("--name", default="dcra_20260714_210218_a5_k5_seed1", help="Name under runs/test for this validation run.")
