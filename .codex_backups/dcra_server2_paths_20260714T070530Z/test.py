...
def parse_args():
    ...
    parser.add_argument(
        "--weights",
        default="/home/rom305/zzf/yolov13-305/runs/train/ducra_v4_1/weights/best.pt",
    ...
    parser.add_argument("--device", default="2", help="CUDA device id used for validation.")
...
data_yaml = '/home/rom305/zzf/yolov13-305/data.yaml'
...
results = model.val(
    ...
    plots=True,
    save_json=True,
    project='/home/rom305/zzf/yolov13-305/runs/test',
    name=args.name,
)
