#!/usr/bin/env python3
"""Train one deterministic D1--D4 DGMR-LCER-DCRA seed on URPC2020half."""
...
from dgmr_lcer_dcra_experiments import MODEL_FILES, STRUCTURES, resolve_model  # noqa: E402
