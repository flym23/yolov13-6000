#!/usr/bin/env bash
# L3-CRU T1--T7: direct-start, pretrained, stage-synchronous three-seed protocol.
set -Eeuo pipefail
...
write_state running "direct_user_start=true; original_yolov13_reused=true; initialization=yolov13n.pt"
...
for stage in "${STAGES[@]}"; do
  ...
  CURRENT_STAGE="$stage"
  write_state training "direct_user_start=true; initialization=yolov13n.pt; three_parallel_seeds=true"
  TRAIN_PIDS=()
