#!/usr/bin/env python3
"""Train one UFCR ablation worker with the server's existing YOLOv13 settings."""
...
MODEL_FILES = {
    "a1": "yolov13_ufcr_a1.yaml",
    "a2": "yolov13_ufcr_a2.yaml",
    "a3": "yolov13_ufcr_a3.yaml",
    "a4": "yolov13_ufcr_a4.yaml",
}


def parse_args():
    parser = argparse.ArgumentParser(description="Train a single UFCR ablation stage/seed.")
