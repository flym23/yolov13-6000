...
MODEL_YAMLS = [
    ROOT / "ultralytics/cfg/models/v13/yolov13-dcra.yaml",
    ROOT / "ultralytics/cfg/models/v13/yolov13-dcra-no-entropy.yaml",
    ROOT / "ultralytics/cfg/models/v13/yolov13-dcra-deep-only.yaml",
    ROOT / "ultralytics/cfg/models/v13/yolov13-dcra-tau020.yaml",
    ROOT / "ultralytics/cfg/models/v13/yolov13-dcra-k5.yaml",
]
