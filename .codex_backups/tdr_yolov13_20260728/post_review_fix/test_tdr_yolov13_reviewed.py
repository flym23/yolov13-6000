...
TDR_YAMLS = (
    Path("ultralytics/cfg/models/v13/yolov13n-tdr-t1-tier.yaml"),
    Path("ultralytics/cfg/models/v13/yolov13n-tdr-t2-sadi.yaml"),
    Path("ultralytics/cfg/models/v13/yolov13n-tdr-t3-brd.yaml"),
    Path("ultralytics/cfg/models/v13/yolov13n-tdr-t4-tier-sadi.yaml"),
    Path("ultralytics/cfg/models/v13/yolov13n-tdr-t5-tier-brd.yaml"),
    Path("ultralytics/cfg/models/v13/yolov13n-tdr-t6-sadi-brd.yaml"),
    Path("ultralytics/cfg/models/v13/yolov13n-tdr-t7-full.yaml"),
)
